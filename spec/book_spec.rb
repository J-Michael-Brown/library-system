...
describe(Book) do
  ...
  describe("#save") do
    it("lets you save books to the database") do
      book = Book.new({:title => "Epicodus stuff", :author => "Micheal"})
      book.save()
  ...
  describe(".find") do
    it "returns a stored book based on the given Id." do
      book = Book.new({:title => "Finder Tester", :author => "Micheal"})
      book.save()
  ...
  describe("#==") do
    it("is the same book if it has the same title") do
      book1 = Book.new({:title => "Epicodus stuff", :author => "Micheal"})
      book2 = Book.new({:title => "Epicodus stuff", :author => "Micheal"})
  ...
  describe("#delete!") do
    it "deletes book from database" do
      book3 = Book.new({:title => "deletion test", :author => "Micheal"})
      book3.save()
